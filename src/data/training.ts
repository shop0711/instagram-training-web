...
export const trainingSlides: SlideData[] = [
  ...
  },
  {
    ...
    speakerNote:
      '1枚目は店頭のPOPと同じ役割です。お客様はキャプションを読む前に、まず画像だけで見るかどうかを判断します。「0.5秒」で、何の投稿か、なぜ今見るべきか、主役は何かが分かる状態を目指します。カルーセル投稿では、1枚目で止めて、2〜4枚目で詳しく伝えます。1枚目が弱いと、続きを見てもらえません。タイトル、商品名、日付、イベント名などの重要な文字は端に置かず、中央付近に配置します。プロフィールグリッドで見切れにくくなり、ホーム画面もきれいに見えます。'
  },
  {
